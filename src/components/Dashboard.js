...
const navigation = [
  ...
  { name: 'Save', href: '#', icon: UsersIcon, current: false },
  { name: 'Learn', href: '#', icon: FolderIcon, current: false },
                    ...
                    <>
                      ...
                      >
                        ...
                        >
                            ...
                            <Menu.Item>
                                <button className="block py-2 px-4 text-sm text-gray-700" onClick={handleLogout}>Sign Out</button>
                            </Menu.Item>
